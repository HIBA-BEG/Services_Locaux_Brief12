...
<body class="bg-white font-sans leading-normal tracking-normal">
  ...
  <div class="flex text-white font-extrabold">
     ...
     Main Line Logo
        ...
        <div class="flex pl-4 text-sm">
            ...
            <header class="container mx-auto px-4 py-6 flex items-center justify-between">
                <a href="#" class="font-bold text-white text-xl">Ghostwind CSS 👻 Stripe Menu</a>
                <nav>
                    <ul class="flex items-center justify-center font-semibold">
                        <li class="relative group px-3 py-2">
                            <button class="hover:opacity-50 text-white cursor-default " aria-haspopup="true">
                                Products
                            </button>
                            <div
                        ...
                        <li class="relative group px-3 py-2">
                            <button class="text-white hover:opacity-50 cursor-default" aria-haspopup="true">
                                Solutions
                            </button>
                            <div
                    ...
                    <ul>
                        <li>
                            <a href="index.html"
                                ...
                                <svg class="stroke-current" width="10" height="10" stroke-width="2"
                                    viewBox="0 0 10 10" aria-hidden="true" color="white">
                                    <g fill-rule="evenodd">
                                        <path
    ...
    <div class="text-center pt-16 md:pt-32">
        <p class="text-sm md:text-base text-green-500 font-bold">04 JULY 2023 <span class="text-gray-900">/</span>
            GETTING STARTED</p>
            ...
            <div class="bg-white w-full p-8 md:p-24 text-xl md:text-2xl text-gray-800 leading-normal"
                ...
                <p class="text-2xl md:text-3xl mb-5">
                    👋 Welcome fellow <a
                        ...
                        class="text-gray-800 hover:text-green-500 no-underline border-b-2 border-green-500"
                        href="https://www.ghost.org">Ghost</a> fan. This starter template is an attempt to replicate
                    the default Ghost theme <a
                        class="text-gray-800 hover:text-green-500 no-underline border-b-2 border-green-500"
                ...
                <div class="w-full md:w-1/3 px-2 pb-12">
                    <div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative smooth">
                        <a href="#" class="no-underline hover:no-underline">
                            <img src="https://source.unsplash.com/8rj4sz9YLCI/400x200"
                            ...
                            <div class="p-6 h-auto md:h-48">
                                ...
                                <p class="text-gray-800 font-serif text-base mb-5">
                                    I’ll be honest, we’re throwing science at the wall here to see what sticks. No idea
                                    what it’ll do. Probably nothing. Best case scenario you might get some super powers.
                                    Worst case, some tumors, which we’ll cut out.
                                </p>
                            </div>
