                    ...
                    <div class="flex flex-wrap justify-between pt-12 -mx-6">
                        ...
                        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                                ...
                                <div class="w-full font-bold text-xl text-gray-900 px-6">{{ $service->title }} </div>
                                <p class="w-full text-gray-600 text-xs md:text-sm px-6">{{ $service->cost }}</p>
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <img class="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="Author Name"
                                        src="http://i.pravatar.cc/300" alt="Avatar of Author">
                                    <p class="text-gray-600 text-xs md:text-sm">{{ $service->updated_at }}</p>
                                </div>
                            </div>
                        </div>
                @endforeach
